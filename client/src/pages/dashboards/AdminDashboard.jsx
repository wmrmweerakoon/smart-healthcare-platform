      ...
      <div className="container">
        ...
        <div className="dashboard-grid">
          <div className="dashboard-card card">
            ...
            <h3>Users</h3>
            <p>Manage all platform users and their access levels</p>
          ...
          <div className="dashboard-card card">
            <div className="dashboard-card-icon">🩺</div>
            <h3>Doctors</h3>
            <p>Manage registered doctors and their profiles</p>
          ...
          <div className="dashboard-card card">
            <div className="dashboard-card-icon">📅</div>
            <h3>Appointments</h3>
            <p>Monitor all platform appointments and statuses</p>
            <span className="dashboard-card-stat">0 total</span>
          </div>
          ...
          <div className="dashboard-card card">
            <div className="dashboard-card-icon">💰</div>
            <h3>Revenue</h3>
            <p>Track platform revenue and payment analytics</p>
